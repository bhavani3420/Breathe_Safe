  ...
  const fetchLatestAssessment = async () => {
    try {
      ...
      const response = await fetch(
        "https://breathesafe-project-backend.onrender.com/api/health-assessment/latest",
        {
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = existingAssessmentId
        ? `https://breathesafe-project-backend.onrender.com/api/health-assessment/${existingAssessmentId}`
        : "https://breathesafe-project-backend.onrender.com/api/health-assessment";
